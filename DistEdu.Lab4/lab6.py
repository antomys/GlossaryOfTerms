...
if __name__ == "__main__":
    ...
    destination_path = "compressed_dictionary.dat"
    decompressed_path = "decompressed_dictionary.txt"

    source_path1 = "index.txt"
    destination_path1 = "compressed_index.dat"
    decompressed_path1 = "decompressed__index.txt"
    # print("Intervals: ", i)
